...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  3 12:27:30 2017
...
c=0.008*0.45*60/(0.141*log(2)*15)
...
tyson.model['mu']=dnamodel2.reactions.r_2133.flux*log(2)*15*c/(0.45*60)
...
result = tyson.simulate(0,169,170)
times = result[:,0]
...
for i in range(0,sim):
    ...
    #Default Growth Rate
    varIC.model['mu']=dnamodel2.reactions.r_2133.flux/(60*log(2))
    ...
    samplemass.append(result[np.random.randint(0,250),4])
